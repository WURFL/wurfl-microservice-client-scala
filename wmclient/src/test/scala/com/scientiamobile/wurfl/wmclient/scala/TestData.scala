...
object TestData {
  ...
  object TestData {
    val USER_AGENTS: List[String] = List[String]("5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.95 Safari/537.36 ASXACT12779",
      "97718A_ABROAD/V1 Linux/3.4.5 Android/4.2.2 Release/05.02.2013 Browser/AppleWebKit534.30 Mobile Safari/534.30 MBBMS/2.2;", "A1034/1.0 Browser/Obigo/Q03C Profile",
      ...
      "ZTE-U F110/WAP2.0 Profile/MIDP-2.0", "ZTE-Vodafone550(Keren)",
      ...
      "YouTube/12.05.7 CFNetwork/758.5.3 Darwin/15.6.0", "YouTube/12.05.7 CFNetwork/808.2.16 Darwin/16.3.0",
      ...
      "Youdao Desktop Dict (Windows NT 6.1)", "Youku HD;4.1.1;iPhone OS;10.2.1;iPad5,3",
      ...
      "WordPress/4.7; http://digrit.com", "WordPress/4.7; http://turistigid.com",
      "WordPress/4.7; http://www.kunstleben-berlin.de", "WordPress/5226; http://www.stadtbekannt.at",
      ...
      "WordPress.com; https://honors174winter2017.wordpress.com", "MyApp/1.0")

    def createTestUserAgentList: Array[String] = {
      val userAgents = List()
      for (i <- 0 until 100) {
        userAgents.appendedAll(TestData.USER_AGENTS)
      }
      userAgents.toArray
    }
  }
